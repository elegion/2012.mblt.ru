...
w.fastXDM = {
  _id: 0,
  helperUrl: ((location.protocol === 'en.html') ? 'https:' : 'http:') + '//vk.com/js/api/xdmHelper.js',
...
if (VK._protocol !== 'en.html') {
  VK._protocol = ((location.protocol === 'en.html') ? 'https:' : 'http:');
}
...
if (!VK.Widgets) {
  ...
  VK.Widgets.Comments = function(objId, options, page) {
    ...
    if (options.browse) { // browse all comments
      ...
      if (url.substr(0, 1) == 'index-2.html') {
  ...
  VK.Widgets._constructor = function(widgetUrl, objId, options, params, funcs, defaults, onDone, widgetId, iter) {
    ...
    funcs.updateVersion = function(ver) {
      if (ver > 1) {
        VK.Api.attachScript('js/api/openapi_updated41d.html?'+parseInt(ver));
      }
    }
